            ...
            <div class="dati cliente">
                <div class="form-container">
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Cliente Vendita: " CssClass="form-label" ForeColor="#236BB3"></asp:Label>
                        <asp:DropDownList ID="ddlClienti" runat="server" AutoPostBack="true" ForeColor="#236BB3" OnSelectedIndexChanged="ddlClienti_SelectedIndexChanged"></asp:DropDownList>
                        <span>&nbsp;</span>
                        <a href="Clienti_Inserimento.aspx">Nuovo Cliente</a>
                        <span>&nbsp;</span>
                        <a href="Clienti_Modifica.aspx">Modifica dati Cliente</a>
                           <span>&nbsp;</span>
                        <asp:Label ID="Label5" runat="server" Text="Automobili: " CssClass="form-label" ForeColor="#236BB3"></asp:Label>
            ...
            <div class="operazioni-automobile">
                ...
                <div id="dati-vendita">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDataVendita" runat="server" CssClass="form-input" ForeColor="#236BB3" TextMode="Date"></asp:TextBox>
                    </div>
                    <span>&nbsp;</span>
                    <div class="form-group">
                        <asp:Button ID="btnInserimentoDtai" runat="server" Text="Inserimento dati" ForeColor="#236BB3" OnClick="btnInserimentoDtai_Click" />
                    </div>
                </div>
            </div>
        </div>
